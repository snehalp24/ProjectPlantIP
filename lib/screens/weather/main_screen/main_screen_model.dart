...
import 'package:plant_flutter/model/weather/weather_forecast_hourly.dart';
import 'package:plant_flutter/network/weather_api.dart';
...
class MainScreenModel extends ChangeNotifier {
  ...
  Future<void> setup() async {
    _forecastObject ??=
        await WeatherApi().fetchWeatherForecast(cityName: 'Gadhinglaj');
    updateState();
  }
